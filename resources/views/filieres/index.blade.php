...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                @if(Auth::user()->hasRole('Manager') || Auth::user()->hasRole('Administrateur'))
                    <div class="mb-3">
                ...
                <div class="table-responsive">
                    <table id="filieresTable" class="table align-middle table-bordered table-striped"
                        ...
                        <thead>
                            <tr>
                                @if (Auth::user()->hasRole('Manager') or Auth::user()->hasRole('Administrateur'))
                                        <th scope="col" style="width: 10px;"></th>
                                @endif
                                @if (Auth::user()->hasRole('Ufr') or Auth::user()->hasRole('Manager') or Auth::user()->hasRole('Administrateur'))
                                    <th>Département</th>
                                @endif
