...
@section('content')
    <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
            <img src="{{ $universite->logo ? $universite->imageUrl() : asset('images/universites/placeholder.svg') }}"
            ...
            <div class="col">
                <div class="p-2">
                    ...
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i
                                class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $universite->ville ?? 'Non défini' }}
                        </div>
                        <div><i
                                class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $universite->adresse ?? 'Non défini' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="d-flex profile-wrapper">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('universites.edit', compact('universite')) }}" class="btn btn-success"><i
                                class="ri-edit-box-line align-bottom"></i> Editer</a>
                    </div>
                </div>
                <!-- Tab panes -->
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ $universite->nom }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Téléphone :</th>
                                                        <td class="text-muted">
                                                            {{ $universite->telephone ?? '+229 XXXXXXXX' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">E-mail :</th>
                                                        <td class="text-muted">{{ $universite->email ?? '....@gmail.com' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Ville :</th>
                                                        <td class="text-muted">{{ $universite->ville ?? '--' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Création :</th>
                                                        <td class="text-muted">
                                                            {{ \Carbon\Carbon::parse($universite->created_at)->format('d/m/Y') }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="mb-1">Recteur :</p>
                                                        <h6 class="text-truncate mb-0">
                                                            {{ $universite->recteur ?? 'Inconnu' }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <a href="{{ $universite->siteweb ?? '#' }}"
                                                            class="fw-semibold">{{ $universite->siteweb ?? 'Non défini' }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
